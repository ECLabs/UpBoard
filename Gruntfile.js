...
//      },
      backend: { 
				files: [
					...
					'<%= yeoman.app.base %>/server.js',
					'<%= yeoman.app.base %>/config.json'
				], 
      ...
      frontend: {
        files: ['<%= yeoman.app.frontend %>/scripts/{,*/}*.{js,html}'],
    ...
    express: {
      ...
      prod: {
        options: {
          script: '<%= yeoman.dist.base %>/server.js',
          node_env: 'production'
        }
      },
      test: {
...
//            'views/{,*/}*.html',
    ...
    compress:{
      zip: {
        ...
        files: [
          {expand: true, cwd: '<%= yeoman.dist.base %>', src: ['**/*']}
        ]
      },
      tar: {
        options: {
